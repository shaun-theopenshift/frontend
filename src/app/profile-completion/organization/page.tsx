...
export default function OrganizationProfileCompletion() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center relative overflow-hidden bg-[#f6fbfb]">
      {/* Lively Background */}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8 flex flex-col gap-8 text-black relative">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    // onClick={handleAbnLookup} // To be implemented
                    disabled={!organizationDetails.abn}
                  >
                    Lookup
                  </button>
                </div>
                <div className="text-xs text-gray-500 mt-1">(ABN Lookup integration coming soon)</div>
              </div>
              <div>
                <label className="block font-semibold mb-2">Organization Name</label>
                <input className="w-full border rounded-md p-2 text-black" value={organizationDetails.name} onChange={e => setOrganizationDetails({ ...organizationDetails, name: e.target.value })} placeholder="Organization name" />
              </div>
              <div>
              ...
              <div>
                ...
                <input className="w-full border rounded-md p-2 text-black" value={organizationDetails.phone} onChange={e => setOrganizationDetails({ ...organizationDetails, phone: e.target.value })} placeholder="Phone number" />
              </div>
            </div>
