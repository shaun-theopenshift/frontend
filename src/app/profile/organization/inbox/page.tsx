          ...
          >
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div className="flex items-start mb-4">
                <div className="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center font-bold text-sm mr-3">O</div>
                <div className="bg-gray-100 p-3 rounded-xl max-w-[75%]">
                  <p className="text-sm font-semibold text-gray-800">Organisation</p>
                  <p className="text-gray-700">URGENT: Shift change for your 6 PM shift tonight at Harmony Homes. It's now been moved to the Willow Wing.</p>
                </div>
              </div>
              ...
              <div className="flex justify-end mb-4">
                <div className="bg-[#3464b4] text-white p-3 rounded-xl max-w-[75%]">
                  <p className="text-gray-100">Received. Thanks for the heads-up! I'll be there.</p>
                </div>
                <div className="w-8 h-8 rounded-full bg-gray-400 text-white flex items-center justify-center font-bold text-sm ml-3">L</div>
              </div>
              ...
              <div className="flex items-start mb-4">
                ...
                <div className="bg-gray-100 p-3 rounded-xl max-w-[75%]">
                  <p className="text-sm font-semibold text-gray-800">Organisation</p>
                  <p className="text-gray-700">Appreciate the quick response! Also, just a reminder about the updated parking instructions sent yesterday.</p>
                </div>
              </div>
              ...
              <div className="flex justify-end mb-4">
                <div className="bg-[#3464b4] text-white p-3 rounded-xl max-w-[75%]">
                  <p className="text-gray-100">Got it. I saw those. Everything clear on my end.</p>
                </div>
                <div className="w-8 h-8 rounded-full bg-gray-400 text-white flex items-center justify-center font-bold text-sm ml-3">L</div>
              </div>
