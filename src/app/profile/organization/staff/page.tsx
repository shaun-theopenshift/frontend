        ...
        <nav className="mt-5 px-2">
          {SIDEBAR_ITEMS.map((item) => (
            <a
              key={item.label}
              href={item.href}
              className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-brand-dark"
            >
              {item.icon}
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-brand-dark hover:bg-brand-dark"
                  >
                    Edit Profile
                  </button>
                </div>
                <div className="ml-4 flex items-center md:ml-6">
                  <a
                    ...
                    className="p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-dark"
                  >
