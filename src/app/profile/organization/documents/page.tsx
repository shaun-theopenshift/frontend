    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="h-16 flex items-center justify-center border-b">
          <div className="text-2xl font-bold text-[#67b5b5]">TheOpenShift</div>
        </div>
        <nav className="mt-5 px-2">
          {SIDEBAR_ITEMS.map((item) => (
            <a
              key={item.label}
              href={item.href}
              className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-[#67b5b5]"
            >
              {item.icon}
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex items-center">
                <button
                  type="button"
                  className="lg:hidden px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#67b5b5]"
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#67b5b5] hover:bg-[#4a9e9e]"
                  >
                    Edit Profile
                  </button>
                </div>
                <div className="ml-4 flex items-center md:ml-6">
                  <a
                    ...
                    className="p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#67b5b5]"
                  >
